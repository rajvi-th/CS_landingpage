...
const App = () => {
  ...
  return (
    ...
    "
      ...
      "
            >
              ...
              {/* Heading */}
              <h1 className="mt-6 2xl:mt-10 text-4xl md:text-4xl lg:text-5xl 2xl:text-6xl font-semibold leading-tight">
                Manage Every <br />
            ...
            {/* DESKTOP IMAGE ONLY */}
            <div className="hidden lg:flex justify-end items-end pt-15">
              <img
                src={handdImage}
      ...
      text-xs 2xl:text-xl font-semibold
      max-[380px]:text-[9px]
      max-[380px]:px-3
    "
              >
              ...
              <h2
                className="
      font-semibold
      text-2xl 2xl:text-6xl md:text-3xl
      max-[360px]:text-lg
      leading-snug
    "
              >
    ...
    "
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 px-4">
              ...
              <div className="relative flex-1 flex justify-center lg:justify-start">
                <img
                  src={siteImage}
                  alt="Site Workers"
                  className="w-full max-w-md 2xl:max-w-xl mx-auto object-contain"
                />
              </div>
          ...
          <div className="max-w-full mx-auto space-y-10 py-10 px-4 lg:px-14 2xl:px-27 2xl:py-20 bg-[#F3F3F3] border-2 border-[#E9E2D84D]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 2xl:gap-10">
              ...
              <div className="bg-[#EBEAE8] p-6 rounded-2xl flex flex-col">
                ...
                <h3 className="text-2xl 2xl:text-3xl font-medium mb-4">Smart Dashboard</h3>
        ...
        <section id="waitlist" className="py-10 px-4 lg:px-14 2xl:px-27 2xl:py-20 overflow-hidden">
