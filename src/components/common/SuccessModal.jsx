...
import logo from "../../assets/icon/Csmodel.svg";
...
const SuccessModal = ({ isOpen, onClose, email }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="relative w-full max-w-2xl 2xl:max-w-5xl bg-white rounded-[32px] overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300 min-h-[480px] 2xl:min-h-[680px] flex flex-col justify-center">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="px-8 pt-12 pb-10 2xl:pt-20 2xl:pb-20 flex flex-col items-center text-center">
          {/* Illustration */}
          <div className="mb-10 2xl:mb-15">
            <img
              src={logo}
              alt="Success Illustration"
              className="w-48 md:w-64 2xl:w-100 h-auto"
            />
          </div>

          {/* Text Content */}
          <h2 className="text-2xl md:text-3xl 2xl:text-5xl font-bold text-[#2D2D2D] mb-2">
          ...
          <p className="text-[#525465] text-sm md:text-[14px] 2xl:text-2xl leading-relaxed max-w-xl 2xl:max-w-4xl">
            ...
            <span className="font-semibold text-black">{email || "demo56@gmail.com"}</span>.
          </p>
        </div>
      </div>
    </div>
