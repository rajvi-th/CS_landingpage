          ...
          <div className="bg-card rounded-2xl border border-border p-8 md:p-12 shadow-lg">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-3 text-foreground mb-6">
                ...
                <li>
                  <p>
                    <strong>Application</strong> refers to ConstructionSaarthi AI, the software
            ...
            <section className="mb-8">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3 mt-4">Personal Data</h4>
              <p className="text-foreground mb-4">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3 mt-6">Usage Data</h4>
              <p className="text-foreground mb-4">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3 mt-6">
              ...
              <ul className="list-disc pl-6 space-y-4 text-foreground mb-6">
                <li>
                  <p>
            ...
            <section className="mb-8">
              ...
              <h4 className="text-xl font-semibold text-foreground mb-3 mt-4">Law enforcement</h4>
              <p className="text-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Children's Privacy</h2>
              <p className="text-foreground mb-4">
