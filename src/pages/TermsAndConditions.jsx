        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-card rounded-2xl border border-border p-8 md:p-12 shadow-lg">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-2xl font-semibold text-foreground mb-3 mt-6">Definitions</h3>
              <p className="text-foreground mb-4">
              ...
              <ul className="list-disc pl-6 space-y-3 text-foreground mb-6">
                <li>
                  <p>
                    ...
                    downloaded by You on any electronic device, named ConstructionSaarthi AI
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    "Our" in this Agreement) refers to Techifyhouse, 241, Royal Square, VIP Circle,
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to ConstructionSaarthi, accessible from{" "}
                    <a
                      href="https://constructionsaarthi.com"
                      rel="external nofollow noopener"
                      target="_blank"
                      className="text-primary hover:underline"
                    >
                      https://constructionsaarthi.com
                    </a>
                  </p>
                </li>
                <li>
            ...
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Acknowledgment</h2>
              <p className="text-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Termination</h2>
              <p className="text-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Governing Law</h2>
              <p className="text-foreground mb-4">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-2xl font-semibold text-foreground mb-3 mt-6">Severability</h3>
              <p className="text-foreground mb-4">
              ...
              <h3 className="text-2xl font-semibold text-foreground mb-3 mt-6">Waiver</h3>
              <p className="text-foreground mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground mb-4">
                ...
                30 days' notice prior to any new terms taking effect. What constitutes a material
            ...
            <section className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Contact Us</h2>
              <p className="text-foreground mb-4">
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground">
                <li>
                  By email:{" "}
                  <a
                    href="mailto:contact@constructionsaarthi.com"
                    className="text-primary hover:underline"
                  >
